        ...
        <div className="container">
          <div className="profile">
            ...
            <div className="profile-user-settings">
              <h1 className="profile-user-name">Best of 2023</h1>
            ...
            <div className="profile-stats">
              <ul>
                <li>
                  <span className="profile-stat-count">123</span> posts
                </li>
                <li>
                  <span className="profile-stat-count">567</span> followers
                </li>
                <li>
                  <span className="profile-stat-count">1</span> following
                </li>
              </ul>
            </div>
